...
type ItemObj<TitleKey extends LiteralString<TitleKey>, UniqueKey extends LiteralString<UniqueKey>> = {[key in UniqueKey]?: string | number} & {[title in TitleKey]: string} & {
  [k: string]: any;
};

export type ItemType<TitleKey extends LiteralString<TitleKey>, UniqueKey extends LiteralString<UniqueKey>> = string | ItemObj<TitleKey, UniqueKey>;

export type SectionItem<TitleKey extends LiteralString<TitleKey>, UniqueKey extends LiteralString<UniqueKey>> = {
  data: ItemType<TitleKey, UniqueKey>;
  title: string;
  key: string;
};
export interface IndexedSectionListData<TitleKey extends LiteralString<TitleKey>, UniqueKey extends LiteralString<UniqueKey>>
...
export interface IndexedSectionListProps<TitleKey extends LiteralString<TitleKey>, UniqueKey extends LiteralString<UniqueKey>>
  extends Omit<SectionListProps<SectionItem<TitleKey, UniqueKey>>, 'sections' | 'keyExtractor' | 'onScrollToIndexFailed'> {
  /**
   ...
   */
  getSectionProps?: (title: string, unsortedData: SectionItem<TitleKey, UniqueKey>[]) => Partial<IndexedSectionListData<TitleKey, UniqueKey>>;
