...
export default class VideoPlayer extends Component {
  ...
  renderTopControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground source={require('./images/icons/top-vignette.png')} style={[VideoPlayerstyles.controls.column]} imageStyle={[VideoPlayerstyles.controls.vignette]}>
   ...
   */
  renderBack() {
    return this.renderControl(<Image source={require('./images/icons/back.png')} style={VideoPlayerstyles.controls.back} />, this.events.onBack, VideoPlayerstyles.controls.back);
  }
  ...
  renderVolume() {
    return (
      <View style={VideoPlayerstyles.volume.container}>
        ...
        <View style={[VideoPlayerstyles.volume.handle, {left: this.state.volumePosition}]} {...this.player.volumePanResponder.panHandlers}>
          <Image style={VideoPlayerstyles.volume.icon} source={require('./images/icons/volume.png')} />
        </View>
      </View>
    );
  }
   ...
   */
  renderFullscreen() {
    let source = this.state.isFullscreen === true ? require('./images/icons/shrink.png') : require('./images/icons/expand.png');
    return this.renderControl(<Image source={source} />, this.methods.toggleFullscreen, VideoPlayerstyles.controls.fullscreen);
  }
  ...
  renderBottomControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground source={require('./images/icons/bottom-vignette.png')} style={[VideoPlayerstyles.controls.column]} imageStyle={[VideoPlayerstyles.controls.vignette]}>
          {seekbarControl}
          <SafeAreaView style={[VideoPlayerstyles.controls.row, VideoPlayerstyles.controls.bottomControlGroup]}>
            {playPauseControl}
            {this.renderTitle()}
            {timerControl}
          </SafeAreaView>
  ...
  renderSeekbar() {
    return (
      <View style={VideoPlayerstyles.seekbar.container} collapsable={false} {...this.player.seekPanResponder.panHandlers}>
        <View style={VideoPlayerstyles.seekbar.track} onLayout={event => (this.player.seekerWidth = event.nativeEvent.layout.width)} pointerEvents={'none'}>
          <View
            style={[
        ...
        <View style={[VideoPlayerstyles.seekbar.handle, {left: this.state.seekerPosition}]} pointerEvents={'none'}>
          <View style={[VideoPlayerstyles.seekbar.circle, {backgroundColor: this.props.seekColor || '#FFF'}]} pointerEvents={'none'} />
        </View>
      </View>
    );
  }
   ...
   */
  renderPlayPause() {
    let source = this.state.paused === true ? require('./images/icons/play.png') : require('./images/icons/pause.png');
    return this.renderControl(<Image source={source} />, this.methods.togglePlayPause, VideoPlayerstyles.controls.playPause);
  }
    ...
    if (this.opts.title) {
      return (
        <View style={[VideoPlayerstyles.controls.control, VideoPlayerstyles.controls.title]}>
          <Text style={[VideoPlayerstyles.controls.text, VideoPlayerstyles.controls.titleText]} numberOfLines={1}>
            {this.opts.title || ''}
          </Text>
        </View>
      );
   ...
   */
  renderTimer() {
    return this.renderControl(<Text style={VideoPlayerstyles.controls.timerText}>{this.calculateTime()}</Text>, this.methods.toggleTimer, VideoPlayerstyles.controls.timer);
  }
        ...
        <SafeAreaView style={VideoPlayerstyles.error.container}>
          <TouchableOpacity onPress={() => this.reloadPlayer()}>
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <Image source={require('./images/icons/error-icon.png')} style={VideoPlayerstyles.error.icon} />
  ...
  render() {
    return (
      <TouchableWithoutFeedback onPress={this.events.onScreenTouch} style={[VideoPlayerstyles.player.container, this.styles.containerStyle]}>
        {this.state.player ? (
          <ImageBackground
            resizeMode="cover"
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity onPress={() => this.playVideo()}>
                  <Icon name="play-circle-fill" size={50} color="#6200ee" />
                </TouchableOpacity>
              </View>
            </View>
          </ImageBackground>
