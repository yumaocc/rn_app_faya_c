/**
 * 注意。此文件仅作为对比，这是ant默认主题，如要修改主题，请修改./defaultTheme.ts文件
 * [主题地址](https://github.com/ant-design/ant-design-mobile-rn/blob/master/components/style/themes/default.tsx)
 */
